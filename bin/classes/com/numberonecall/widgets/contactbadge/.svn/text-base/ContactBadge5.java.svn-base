...
package com.numberonecall.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.numberonecall.widgets.contactbadge.QuickContactBadge topBadge) {
