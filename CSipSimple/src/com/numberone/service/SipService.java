...
import com.numberone.api.ISipConfiguration;
...
import com.numberone.pjsip.PjSipCalls;
import com.numberone.pjsip.PjSipService;
import com.numberone.pjsip.UAStateReceiver;
import com.numberone.service.receiver.DynamicReceiver4;
import com.numberone.service.receiver.DynamicReceiver5;
import com.numberone.ui.incall.InCallMediaControl;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.numberone.ui.PrivilegedOutgoingCallBroadcaster");
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.numberone.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.numberone.SipService");
