...
import com.numberone.api.SipManager.PresenceStatus;
import com.numberone.api.SipUri.ParsedSipContactInfos;
import com.numberone.service.MediaManager;
import com.numberone.service.SipService;
import com.numberone.service.SipService.SameThreadException;
import com.numberone.service.SipService.SipRunnable;
import com.numberone.service.SipService.ToCall;
import com.numberone.utils.ExtraPlugins;
...
import com.numberone.utils.TimerWrapper;
import com.numberone.utils.ExtraPlugins.DynCodecInfos;
...
public class PjSipService {
                ...
                if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)){
                    ...
                    if(videoPlugins.size() > 0) {
                        ...
                        // Capture
                        {
                            ...
                            try {
                                ComponentName cmp = new ComponentName("com.numberone.plugins.video", "com.numberone.plugins.video.CaptureReceiver");
    ...
    private int sendDtmf(final int callId, String keyPressed) throws SameThreadException {
        ...
        if(!TextUtils.isEmpty(remainingDtmf)) {
            if(tasksTimer == null) {
                tasksTimer = new Timer("com.numberone.PjSipServiceTasks");
            }
