...
import com.numberone.api.SipMessage;
...
*/	
	...
	public void initService(PjSipService srv) {
		...
		if (eventLock == null) {
			...
			eventLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.numberone.inEventLock");
			eventLock.setReferenceCounted(true);

		}
		if(ongoingCallLock == null) {
            PowerManager pman = (PowerManager) pjService.service.getSystemService(Context.POWER_SERVICE);
            ongoingCallLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.numberone.ongoingCallLock");
