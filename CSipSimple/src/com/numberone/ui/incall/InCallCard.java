...
import com.numberone.api.SipCallSession.InvState;
import com.numberone.api.SipUri.ParsedSipContactInfos;
import com.numberone.models.CallerInfo;
import com.numberone.service.SipService;
import com.numberone.utils.ContactsAsyncHelper;
...
import com.numberone.utils.ExtraPlugins.DynActivityPlugin;
        ...
        public void run() {
            ...
            if(w > 0 && h > 0) {
                ...
                if(currentRatio < minButtonRation && !hasVideo) {
                    lp.height = (int) ((0.0f - minButtonRation) * newHeight); 
                }else {
