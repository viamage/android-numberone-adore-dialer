...
package com.numberone.ui.incall;
...
import com.numberone.ui.PickupSipUri;
import com.numberone.ui.incall.CallProximityManager.ProximityDirector;
import com.numberone.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.numberone.utils.CallsUtils;
...
import com.numberone.utils.keyguard.KeyguardWrapper;
import com.numberone.widgets.IOnLeftRightChoice;
import com.numberone.widgets.ScreenLocker;
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.numberone.videoCall");
