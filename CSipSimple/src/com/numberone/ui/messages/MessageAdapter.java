...
package com.numberone.ui.messages;
...
import com.numberone.utils.SmileyParser;
import com.numberone.widgets.contactbadge.QuickContactBadge;
import com.numberone.widgets.contactbadge.QuickContactBadge.ArrowPosition;
...
public class MessageAdapter extends ResourceCursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (type == SipMessage.MESSAGE_TYPE_QUEUED) {
            ...
            tagView.deliveredIndicator.setImageResource(R.drawable.account_over);
