...
package com.numberone.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.numberone.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.numberone.utils.accessibility.Accessibility3();
			}
		}
