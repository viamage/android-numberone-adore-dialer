...
package com.numberone.widgets.contactbadge;
...
public class ContactBadge5 extends ContactBadgeContract {
    ...
    public ContactBadge5(Context context, AttributeSet attrs, int defStyle, com.numberone.widgets.contactbadge.QuickContactBadge topBadge) {
