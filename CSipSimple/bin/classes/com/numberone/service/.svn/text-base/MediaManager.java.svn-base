...
import com.numberone.utils.Ringer;
import com.numberone.utils.accessibility.AccessibilityWrapper;
import com.numberone.utils.audio.AudioFocusWrapper;
import com.numberone.utils.bluetooth.BluetoothWrapper;
import com.numberone.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.numberone.onIncomingCall.SCREEN");
