 ...
 * Original file: D:\\Florin\\CSipSimple(4)\\CSipSimple\\src\\com\\numberone\\api\\ISipService.aidl
 */
package com.numberone.api;
public interface ISipService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.numberone.api.ISipService
{
private static final java.lang.String DESCRIPTOR = "com.numberone.api.ISipService";
...
/**
 * Cast an IBinder object into an com.numberone.api.ISipService interface,
 * generating a proxy if needed.
 */
public static com.numberone.api.ISipService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.numberone.api.ISipService))) {
return ((com.numberone.api.ISipService)iin);
}
return new com.numberone.api.ISipService.Stub.Proxy(obj);
}
...
int _arg0;
_arg0 = data.readInt();
com.numberone.api.SipProfileState _result = this.getSipProfileState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.numberone.api.SipCallSession _result = this.getCallInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.numberone.api.SipCallSession[] _result = this.getCalls();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.numberone.api.SipCallSession _arg0;
if ((0!=data.readInt())) {
_arg0 = com.numberone.api.SipCallSession.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.numberone.api.MediaState _result = this.getCurrentMediaState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements com.numberone.api.ISipService
{
...
/**
	...
	*/
@Override public com.numberone.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberone.api.SipProfileState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(accountId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberone.api.SipProfileState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.numberone.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberone.api.SipCallSession _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(callId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberone.api.SipCallSession.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.numberone.api.SipCallSession[] getCalls() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberone.api.SipCallSession[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.numberone.api.SipCallSession.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public void adjustVolume(com.numberone.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.numberone.api.MediaState getCurrentMediaState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberone.api.MediaState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentMediaState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberone.api.MediaState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
	...
	* @return the Profile state
	*/
public com.numberone.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException;
//Call configuration control
/**
	 * Switch next incoming request to auto answer
	 */
...
public com.numberone.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException;
public com.numberone.api.SipCallSession[] getCalls() throws android.os.RemoteException;
...
public void adjustVolume(com.numberone.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException;
public com.numberone.api.MediaState getCurrentMediaState() throws android.os.RemoteException;
