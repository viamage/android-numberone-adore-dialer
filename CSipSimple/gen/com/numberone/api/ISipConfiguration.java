 ...
 * Original file: D:\\Florin\\CSipSimple(4)\\CSipSimple\\src\\com\\numberone\\api\\ISipConfiguration.aidl
 */
package com.numberone.api;
public interface ISipConfiguration extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.numberone.api.ISipConfiguration
{
private static final java.lang.String DESCRIPTOR = "com.numberone.api.ISipConfiguration";
...
/**
 * Cast an IBinder object into an com.numberone.api.ISipConfiguration interface,
 * generating a proxy if needed.
 */
public static com.numberone.api.ISipConfiguration asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.numberone.api.ISipConfiguration))) {
return ((com.numberone.api.ISipConfiguration)iin);
}
return new com.numberone.api.ISipConfiguration.Stub.Proxy(obj);
}
...
private static class Proxy implements com.numberone.api.ISipConfiguration
{
