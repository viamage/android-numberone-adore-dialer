 ...
 * Original file: /Users/m8/pajeet/android-numberone-adore-dialer/src/com/numberonecall/api/ISipService.aidl
 */
package com.numberonecall.api;
public interface ISipService extends android.os.IInterface
{
/** Local-side IPC implementation stub class. */
public static abstract class Stub extends android.os.Binder implements com.numberonecall.api.ISipService
{
private static final java.lang.String DESCRIPTOR = "com.numberonecall.api.ISipService";
...
/**
 * Cast an IBinder object into an com.numberonecall.api.ISipService interface,
 * generating a proxy if needed.
 */
public static com.numberonecall.api.ISipService asInterface(android.os.IBinder obj)
{
if ((obj==null)) {
return null;
}
android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
if (((iin!=null)&&(iin instanceof com.numberonecall.api.ISipService))) {
return ((com.numberonecall.api.ISipService)iin);
}
return new com.numberonecall.api.ISipService.Stub.Proxy(obj);
}
...
int _arg0;
_arg0 = data.readInt();
com.numberonecall.api.SipProfileState _result = this.getSipProfileState(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
int _arg0;
_arg0 = data.readInt();
com.numberonecall.api.SipCallSession _result = this.getCallInfo(_arg0);
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
{
data.enforceInterface(DESCRIPTOR);
com.numberonecall.api.SipCallSession[] _result = this.getCalls();
reply.writeNoException();
...
{
data.enforceInterface(DESCRIPTOR);
com.numberonecall.api.SipCallSession _arg0;
if ((0!=data.readInt())) {
_arg0 = com.numberonecall.api.SipCallSession.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
{
data.enforceInterface(DESCRIPTOR);
com.numberonecall.api.MediaState _result = this.getCurrentMediaState();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
_result.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
private static class Proxy implements com.numberonecall.api.ISipService
{
...
/**
	...
	*/
@Override public com.numberonecall.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberonecall.api.SipProfileState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(accountId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberonecall.api.SipProfileState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.numberonecall.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberonecall.api.SipCallSession _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeInt(callId);
...
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberonecall.api.SipCallSession.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
@Override public com.numberonecall.api.SipCallSession[] getCalls() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberonecall.api.SipCallSession[] _result;
...
_reply.readException();
_result = _reply.createTypedArray(com.numberonecall.api.SipCallSession.CREATOR);
}
finally {
_reply.recycle();
_data.recycle();
...
@Override public void adjustVolume(com.numberonecall.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public com.numberonecall.api.MediaState getCurrentMediaState() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
com.numberonecall.api.MediaState _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentMediaState, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
_result = com.numberonecall.api.MediaState.CREATOR.createFromParcel(_reply);
}
else {
_result = null;
}
...
/**
	 ...
	 */
@Override public void startRecording(int callId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
/**
	...
	* @return the Profile state
	*/
public com.numberonecall.api.SipProfileState getSipProfileState(int accountId) throws android.os.RemoteException;
//Call configuration control
/**
	 * Switch next incoming request to auto answer
	 */
...
public com.numberonecall.api.SipCallSession getCallInfo(int callId) throws android.os.RemoteException;
public com.numberonecall.api.SipCallSession[] getCalls() throws android.os.RemoteException;
...
public void adjustVolume(com.numberonecall.api.SipCallSession callInfo, int direction, int flags) throws android.os.RemoteException;
public com.numberonecall.api.MediaState getCurrentMediaState() throws android.os.RemoteException;
