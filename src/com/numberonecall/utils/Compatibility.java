...
package com.numberonecall.utils;
...
public final class Compatibility {
    ...
    private static void resetCodecsSettings(PreferencesWrapper preferencesWrapper) {
        ...
        // For Narrowband
        preferencesWrapper.setCodecPriority("G729/8000/1", SipConfigManager.CODEC_NB, "123");
        preferencesWrapper.setCodecPriority("PCMA/8000/1", SipConfigManager.CODEC_NB, "70");
        preferencesWrapper.setCodecPriority("PCMU/8000/1", SipConfigManager.CODEC_NB, "60"); 
        preferencesWrapper.setCodecPriority("GSM/8000/1", SipConfigManager.CODEC_NB, "50");
        ...
        // For Wideband
        preferencesWrapper.setCodecPriority("G729/8000/1", SipConfigManager.CODEC_WB, "123");
        preferencesWrapper.setCodecPriority("PCMA/8000/1", SipConfigManager.CODEC_WB, "70");
        preferencesWrapper.setCodecPriority("PCMU/8000/1", SipConfigManager.CODEC_WB, "60"); 
        preferencesWrapper.setCodecPriority("GSM/8000/1", SipConfigManager.CODEC_WB, "50");
    ...
    public static void updateVersion(PreferencesWrapper prefWrapper, int lastSeenVersion,
       ...
       //     prefWrapper.setCodecPriority("AMR/8000/1", SipConfigManager.CODEC_WB, "0");
        ...
        if(lastSeenVersion < 1109) {
            prefWrapper.setPreferenceStringValue(SipConfigManager.TIMER_MIN_SE, "128");
