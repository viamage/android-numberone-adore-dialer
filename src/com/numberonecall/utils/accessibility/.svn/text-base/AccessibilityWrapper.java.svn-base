...
package com.numberonecall.utils.accessibility;
	...
	public static AccessibilityWrapper getInstance() {
		if(instance == null) {
			if(Compatibility.isCompatible(4)) {
			    instance = new com.numberonecall.utils.accessibility.Accessibility4();
			}else {
			    instance = new com.numberonecall.utils.accessibility.Accessibility3();
			}
		}
