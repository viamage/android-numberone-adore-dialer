package com.numberonecall.ui.prefs.hc;
...
import com.numberonecall.ui.prefs.PrefsFilters;
import com.numberonecall.ui.prefs.PrefsLogic;
...
public class MainPrefs extends SherlockPreferenceActivity {
    ...
    public void onBuildHeaders(List<Header> target) {
        ...
        for(Header header : target) {
            ...
            if(header.iconRes == R.drawable.account_over) {
                header.intent = new Intent(SipManager.ACTION_UI_PREFS_FAST);
            }else if(header.iconRes == R.drawable.account_over) {
