...
@SuppressLint("NewApi") public class Authorised extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startWebView("https://portal.numberonecall.com/mobile-anis");
		...
		webView.setWebViewClient(new WebViewClient() {      
	        ...
	        public void onLoadResource (WebView view, String url) {
	            if (progressDialog == null) {
	                ...
	                progressDialog = new ProgressDialog(Authorised.this);
