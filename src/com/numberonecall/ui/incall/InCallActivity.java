...
package com.numberonecall.ui.incall;
...
import com.numberonecall.ui.PickupSipUri;
import com.numberonecall.ui.incall.CallProximityManager.ProximityDirector;
import com.numberonecall.ui.incall.DtmfDialogFragment.OnDtmfListener;
import com.numberonecall.utils.CallsUtils;
...
import com.numberonecall.utils.keyguard.KeyguardWrapper;
import com.numberonecall.widgets.IOnLeftRightChoice;
import com.numberonecall.widgets.ScreenLocker;
...
public class InCallActivity extends SherlockFragmentActivity implements IOnCallActionTrigger, 
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        wakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK
                ...
                "com.numberonecall.onIncomingCall");
    ...
    private void attachVideoPreview() {
        ...
        if(prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_VIDEO)) {
            ...
            if(videoWakeLock == null) {
                videoWakeLock = powerManager.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "com.numberonecall.videoCall");
    ...
    */
    ...
    public void showDialpad(int callId) {
