...
package com.numberonecall.service;
...
import com.numberonecall.api.ISipConfiguration;
import com.numberonecall.api.ISipService;
import com.numberonecall.R;
import com.numberonecall.api.MediaState;
...
import com.numberonecall.pjsip.PjSipCalls;
import com.numberonecall.pjsip.PjSipService;
import com.numberonecall.pjsip.UAStateReceiver;
import com.numberonecall.service.receiver.DynamicReceiver4;
import com.numberonecall.service.receiver.DynamicReceiver5;
import com.numberonecall.ui.incall.InCallMediaControl;
import com.numberonecall.utils.Compatibility;
import com.numberonecall.utils.CustomDistribution;
...
//		connectivityManager = (ConnectivityManager) getSystemService(Context.CONNECTIVITY_SERVICE);
	...
	private void applyComponentEnablingState(boolean active) {
        ...
        ComponentName cmp = new ComponentName(this, "com.numberonecall.ui.PrivilegedOutgoingCallBroadcaster");
	...
	private synchronized void acquireResources() {
		...
		if (prefsWrapper.getPreferenceBooleanValue(SipConfigManager.USE_PARTIAL_WAKE_LOCK)) {
			...
			if (wakeLock == null) {
				wakeLock = pman.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "com.numberonecall.SipService");
		...
		if (wifiLock == null) {
			...
			wifiLock = wman.createWifiLock(mode, "com.numberonecall.SipService");
