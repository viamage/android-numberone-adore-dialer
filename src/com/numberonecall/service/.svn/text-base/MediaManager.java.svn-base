...
import com.numberonecall.utils.Ringer;
import com.numberonecall.utils.accessibility.AccessibilityWrapper;
import com.numberonecall.utils.audio.AudioFocusWrapper;
import com.numberonecall.utils.bluetooth.BluetoothWrapper;
import com.numberonecall.utils.bluetooth.BluetoothWrapper.BluetoothChangeListener;
		...
		if(winfo != null) {
			...
			if(service.getPrefs().getPreferenceBooleanValue(SipConfigManager.KEEP_AWAKE_IN_CALL)) {
				if(screenLock == null) {
		            ...
		            screenLock = pm.newWakeLock(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ON_AFTER_RELEASE, "com.numberonecall.onIncomingCall.SCREEN");
