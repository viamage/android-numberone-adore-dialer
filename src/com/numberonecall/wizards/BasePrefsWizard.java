package com.numberonecall.wizards;
...
import com.numberonecall.ui.filters.AccountFilters;
import com.numberonecall.ui.prefs.GenericPrefs;
...
public class BasePrefsWizard extends GenericPrefs {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		long accountId = 1;//intent.getLongExtra(SipProfile.FIELD_ID, SipProfile.INVALID_ID);
	...
	//	WizardInfo wizardInfo = "Basic";//WizardUtils.getWizardClass(wId);
/*		if (wizardInfo == null) {
