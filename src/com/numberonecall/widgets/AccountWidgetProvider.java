...
package com.numberonecall.widgets;
			...
			if(c != null) {
				try {
					if(c.getCount() > 0) {
						...
						views.setImageViewResource(R.id.ind_account, active ? R.drawable.account_over : R.drawable.account_over);
						...
						if(active) {
						    ...
						    if(accountStatusDisplay.checkBoxIndicator == R.drawable.ic_indicator_red) {
						        drawable = R.drawable.account_over;
						        showStatus = true;
